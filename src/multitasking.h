...
signals:
    ...
    void requestMove2Desktop(EffectScreen *screen, int, QVariant);
...
public Q_SLOTS:
    ...
    void moveWindow2Desktop(EffectScreen *screen, int desktop, QVariant winId);
    ...
    QVariantList windowsFor(const EffectScreen *screen, int desktop);
...
private slots:
    ...
    //zhd add start
    void OnWindowLocateChanged(const EffectScreen *screen, int desktop, int winId);
    //zhd add end

    void windowSelectSlot( QVariant winid );
    void removeEffectWindow(const EffectScreen *screen, int desktop, QVariant winid);
...
private:
    ...
    void calculateWindowTransformationsClosest(EffectWindowList windowlist, const EffectScreen *screen,
